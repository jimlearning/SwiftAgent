...
public struct BriefTool: Tool {
    ...
    /// CC: BriefTool.isEnabled() checks isBriefEnabled() — KAIROS/KAIROS_BRIEF feature
    /// + GrowthBook feature flag. SA: always enabled (equivalent for external builds).
    ...
    public func call(input: [String: JSONValue], context: ToolUseContext, canUseTool: CanUseToolFn? = nil, parentMessage: Message? = nil, onProgress: ToolCallProgress? = nil) async throws -> ToolResult {
        guard let msgVal = input["message"], case .string = msgVal else {
