...
└── SwiftAgentApp/            # macOS SwiftUI App (DeepSeek-powered)
    ...
    ├── Content/              # ContentView, ComposerView, NSTableView chat (AppKitChatBridge, ChatTableView/RowView/Blocks/FoldModel/ScrollContainer)
...
| `docs/SWIFTUI_LAYOUT_CACHE.md` | VStack vs LazyVStack layout cache bugs | New layout cache pattern found, fix applied |
